...
use App\Filament\Resources\ProductPropertyResource\Pages;
...
class ProductPropertyResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Свойства товара';
    protected static ?string $navigationLabel = 'Свойства товара';
