    ...
    if (n) {
        ...
        var i = {
            ...
            btnTpl: {
                ...
                close: '<button data-fancybox-close class="fancybox-button fancybox-button--close" title="{{CLOSE}}"><svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M26.8333 2.7025L24.1308 0L13.4167 10.7142L2.7025 0L0 2.7025L10.7142 13.4167L0 24.1308L2.7025 26.8333L13.4167 16.1192L24.1308 26.8333L26.8333 24.1308L16.1192 13.4167L26.8333 2.7025Z" fill="#8A8A8A"/></svg></button>',
                smallBtn: '<button data-fancybox-close class="fancybox-close-small" title="{{CLOSE}}"></button>',
                arrowLeft: '<button data-fancybox-prev class="fancybox-button fancybox-button--arrow_left" title="{{PREV}}"><svg width="15" height="27" viewBox="0 0 15 27" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.5358 3.3446L11.8333 0.234497L0.333252 13.469L11.8333 26.7035L14.5358 23.5934L5.75742 13.469L14.5358 3.3446Z" fill="#8A8A8A"/></svg></button>',
                arrowRight: '<button data-fancybox-next class="fancybox-button fancybox-button--arrow_right" title="{{NEXT}}"><svg width="15" height="27" viewBox="0 0 15 27" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.16661 0.234497L0.464111 3.3446L9.24244 13.469L0.464111 23.5934L3.16661 26.7035L14.6666 13.469L3.16661 0.234497Z" fill="#8A8A8A"/></svg></button>'
            },
            parentEl: "body",
            autoFocus: !1,
            backFocus: !0,
